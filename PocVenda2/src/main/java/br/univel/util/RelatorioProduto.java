...
public class RelatorioProduto {
		...
		public void imprimir(List<Produto> produtos) throws IOException {
			...
			try {
				...
				InputStream is = getClass().getResourceAsStream("RelProduto.jrxml");
				...
				JasperExportManager.exportReportToPdfFile(print, "c:/RelatorioProdutos.pdf");

				// Para abrir o relatorio na pasta que vc salvou, utilizar o comando abaixo

				Runtime.getRuntime().exec("cmd /c start C:/RelatorioProdutos.pdf");
